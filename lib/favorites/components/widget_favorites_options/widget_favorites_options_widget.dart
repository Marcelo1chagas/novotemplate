...
class _WidgetFavoritesOptionsWidgetState
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () async {
        logFirebaseEvent('WIDGET_FAVORITES_OPTIONS_Column_cahkcpao');
                      ...
                      children: [
                        Builder(
                          builder: (context) => InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'WIDGET_FAVORITES_OPTIONS_Row_fvz6h9ag_ON');
          ...
          Align(
            ...
            child: Padding(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  logFirebaseEvent('WIDGET_FAVORITES_OPTIONS_Container_5m9wu');
