...
class MeusingressosWidget extends StatefulWidget {
  const MeusingressosWidget({super.key});
        ...
        actions: [
          Padding(
            ...
            child: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('MEUSINGRESSOS_moreVertical_ICN_ON_TAP');
                ...
                await showModalBottomSheet(
                  ...
                  builder: (context) {
                    return Padding(
                      ...
                      child: WidgetFavoritesOptionsWidget(),
                    );
                  },
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                          ...
                          children: [
                            Expanded(
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'MEUSINGRESSOS_Container_f880yslp_ON_TAP');
                                  logFirebaseEvent(
                            ...
                            Expanded(
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'MEUSINGRESSOS_Container_3ijtf550_ON_TAP');
                                  logFirebaseEvent(
                                      'Container_update_app_state');
                  ...
                  Stack(
                    children: [
                      if (FFAppState().FavoritesTAB == 1)
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 25.0, 0.0, 0.0),
                          child: StreamBuilder<List<FavoritosRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<FavoritosRecord>
                                  favoritosFavoritosRecordList = snapshot.data!;
                              if (favoritosFavoritosRecordList.isEmpty) {
                                return Center(
                                  child: Container(
                                    height: 420.0,
                                    child: WidgetEmptyFavoritesWidget(),
                                  ),
                                );
                              }
                              ...
                              return ListView.separated(
                                ...
                                itemCount: favoritosFavoritosRecordList.length,
                                separatorBuilder: (_, __) =>
                                    SizedBox(height: 25.0),
                                itemBuilder: (context, favoritosIndex) {
                                  final favoritosFavoritosRecord =
                                      favoritosFavoritosRecordList[
                                          favoritosIndex];
                                  return Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        10.0, 0.0, 10.0, 0.0),
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'MEUSINGRESSOS_PAGE_Row_fhw8jee6_ON_TAP');
                      ...
                      if (FFAppState().FavoritesTAB == 2)
                        Padding(
                          padding: EdgeInsets.all(16.0),
                          child: StreamBuilder<List<LancesenviadosRecord>>(
                            stream: queryLancesenviadosRecord(
                              parent: currentUserReference,
                              queryBuilder: (lancesenviadosRecord) =>
                                  lancesenviadosRecord.orderBy('datadolance',
                                      descending: true),
                            ),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              ...
                              List<LancesenviadosRecord>
                                  lancesenviadosLancesenviadosRecordList =
                                  snapshot.data!;
                              ...
                              return ListView.builder(
                                ...
                                itemCount:
                                    lancesenviadosLancesenviadosRecordList
                                        .length,
                                itemBuilder: (context, lancesenviadosIndex) {
                                  final lancesenviadosLancesenviadosRecord =
                                      lancesenviadosLancesenviadosRecordList[
                                          lancesenviadosIndex];
                                  return Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ClipRRect(
                                              ...
                                              child: Image.network(
                                                lancesenviadosLancesenviadosRecord
                                                    .image,
                                                width: 80.0,
                                                height: 80.0,
                                                fit: BoxFit.cover,
