...
class _CancelTicketSuccessWidgetState extends State<CancelTicketSuccessWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('CANCEL_TICKET_SUCCESS_CancelTicketSucces');
      logFirebaseEvent('CancelTicketSuccess_wait__delay');
      await Future.delayed(const Duration(milliseconds: 3000));
      logFirebaseEvent('CancelTicketSuccess_update_component_sta');
      _model.checked = true;
      safeSetState(() {});
    });
              ...
              Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    '8kxfe8yr' /* You have successfully cancelle... */,
                  ),
                  textAlign: TextAlign.center,
            ...
            if (_model.checked == true)
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent(
                        'CANCEL_TICKET_SUCCESS_COMP_OK_BTN_ON_TAP');
