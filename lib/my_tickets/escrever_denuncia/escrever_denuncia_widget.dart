...
import 'escrever_denuncia_model.dart';
export 'escrever_denuncia_model.dart';
...
class EscreverDenunciaWidget extends StatefulWidget {
  ...
  static String routePath = '/escreverDenuncia';
        ...
        appBar: AppBar(
          ...
          leading: Padding(
            ...
            child: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('ESCREVER_DENUNCIA_arrowLeft_ICN_ON_TAP');
                      ...
                      children: [
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'l894meh0' /* A denúncia deve ser feita apen... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .titleSmall
                                        .override(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                          ...
                                          Flexible(
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'qp3waomw' /* Descreva o que aconteceu: */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .headlineSmall
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'm8z0tde7' /* Por favor, forneça o máximo de... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .titleSmall
                                              .override(
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                hintText:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'htvmq2op' /* Digite os detalhes aqui... */,
                                                ),
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'ESCREVER_DENUNCIA_PAGE_ENVIAR_BTN_ON_TAP');
                              ...
                              if (confirmDialogResponse) {
                                ...
                                await DenunciarUsuarioRecord.createDoc(
                                    ...
                                    .set(createDenunciarUsuarioRecordData(
                                  motivodadenuncia: _model.textController1.text,
                                  nomedousuario: columnUsersRecord.name,
                                  descrevaoqueaconteceu:
                                      _model.textController2.text,
                                  data: getCurrentTimestamp,
                                  nomedousuarioDenunciando: valueOrDefault(
                                      currentUserDocument?.name, ''),
                                  contatoUsuarioQuedenunciou: currentUserEmail,
                                ));
                                logFirebaseEvent('Button_alert_dialog');
                                await showDialog(
                                  context: context,
