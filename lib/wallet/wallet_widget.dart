...
class _WalletWidgetState extends State<WalletWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('wallet_biometric_verification');
      final _localAuth = LocalAuthentication();
      bool _isBiometricSupported = await _localAuth.isDeviceSupported();

      if (_isBiometricSupported) {
        try {
          _model.verification = await _localAuth.authenticate(
              localizedReason: FFLocalizations.of(context).getText(
            'rq5go0u1' /* Por favor verifique sua identi... */,
          ));
        } on PlatformException {
          _model.verification = false;
        }
        safeSetState(() {});
      }
    });
        ...
        appBar: AppBar(
          ...
          leading: Padding(
            ...
            child: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('WALLET_PAGE_arrowLeft_ICN_ON_TAP');
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [Color(0xFF1A237E), Color(0xFF2E4FE8)],
                        stops: [0.0, 0.5],
                                ...
                                children: [
                                  if (_model.versaldo == true)
                                    FlutterFlowIconButton(
                                      ...
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'WALLET_PAGE_aberto_ON_TAP');
                                        logFirebaseEvent(
                                            'aberto_update_page_state');
                                  ...
                                  if (_model.versaldo == false)
                                    FlutterFlowIconButton(
                                      ...
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'WALLET_PAGE_fechado_ON_TAP');
                                        logFirebaseEvent(
                                            'fechado_update_page_state');
...
Extrato */
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'WALLET_PAGE_Container_88uu01ju_ON_TAP');
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'WALLET_PAGE_Container_jqdyt6pq_ON_TAP');
                        logFirebaseEvent('Container_update_app_state');
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'p06p6lin' /* Todas as transações são cripto... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodySmall
                                          .override(
