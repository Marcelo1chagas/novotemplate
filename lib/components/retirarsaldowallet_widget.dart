...
///
/// Validação automática com:
///
/// Valor mínimo: R$ 10,00
///
/// Valor máximo: igual ao saldo disponível
///
...
/// [ Insira seu CPF, e-mail ou chave aleatória ]
/// Validação automática por tipo (formato válido de CPF, e-mail ou chave
/// aleatória)
///
/// Placeholder adaptável de acordo com o tipo detectado
///
/// 📌 Informações Importantes (texto auxiliar):
/// As transferências são processadas em até 2 horas úteis.
...
/// Copiar
/// [ 🔁 Solicitar Retirada ]
/// Somente habilitado após valor e chave Pix válidos
///
/// Ao clicar: exibir uma confirmação visual (“Retirada solicitada com
/// sucesso”)
///
/// 🧾 Exibição de Saldo Disponível (acima do campo):
/// plaintext
/// Copiar
/// 💰 Saldo disponível: R$ 842,50
/// Estilo discreto, canto superior direito ou centralizado no topo
///
/// 🛡️ Rodapé com segurança e política:
/// Retiradas são protegidas por criptografia.
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            FFLocalizations.of(context).getText(
                              'atuuodii' /* 📌 Informações Importantes */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                          ...
                          Text(
                            FFLocalizations.of(context).getText(
                              'lold6qnf' /* • As transferências são proces... */,
                            ),
                            style:
                          ...
                          Text(
                            FFLocalizations.of(context).getText(
                              'cegk9pd7' /* • Certifique-se de que a chave... */,
                            ),
                            style:
                                FlutterFlowTheme.of(context).bodySmall.override(
                                      font: GoogleFonts.rubik(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            FFLocalizations.of(context).getText(
                              'h913jrno' /* 🛡️ Segurança e Política */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .labelSmall
                                .override(
                          ...
                          Text(
                            FFLocalizations.of(context).getText(
                              '1p6c6n9t' /* Retiradas são protegidas por c... */,
                            ),
