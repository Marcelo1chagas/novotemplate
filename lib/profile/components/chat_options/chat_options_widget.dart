...
import '/profile/components/clear_chat/clear_chat_widget.dart';
...
class _ChatOptionsWidgetState extends State<ChatOptionsWidget> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () async {
        logFirebaseEvent('CHAT_OPTIONS_COMP_Column_yu0u7dqh_ON_TAP');
                      ...
                      children: [
                        Builder(
                          builder: (context) => InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'CHAT_OPTIONS_COMP_Row_135zd0f4_ON_TAP');
          ...
          Align(
            ...
            child: Padding(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  logFirebaseEvent('CHAT_OPTIONS_Container_s8fbsjjp_ON_TAP');
