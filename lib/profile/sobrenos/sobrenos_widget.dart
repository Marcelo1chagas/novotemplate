...
import 'sobrenos_model.dart';
export 'sobrenos_model.dart';
        ...
        appBar: AppBar(
          ...
          leading: Padding(
            ...
            child: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('SOBRENOS_PAGE_arrowLeft_ICN_ON_TAP');
          ...
          title: Text(
            FFLocalizations.of(context).getText(
              'tm5l6ygk' /* Sobre a Ticket Exchange */,
            ),
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    'h07503do' /* A Ticket Exchange é a platafor... */,
                  ),
