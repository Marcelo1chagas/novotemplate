...
import 'categoriateatro_model.dart';
export 'categoriateatro_model.dart';
...
class CategoriateatroWidget extends StatefulWidget {
  const CategoriateatroWidget({super.key});

  static String routeName = 'categoriateatro';
  static String routePath = '/categoriateatro';

  @override
  State<CategoriateatroWidget> createState() => _CategoriateatroWidgetState();
}

class _CategoriateatroWidgetState extends State<CategoriateatroWidget> {
  late CategoriateatroModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CategoriateatroModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'categoriateatro'});
        ...
        appBar: AppBar(
          ...
          leading: Padding(
            ...
            child: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('CATEGORIATEATRO_arrowLeft_ICN_ON_TAP');
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            children: [
                              Expanded(
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'CATEGORIATEATRO_Image_spqnntid_ON_TAP');
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'i9rf40gd' /* Encontre os melhores eventos m... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              'jchunp2k' /* Descubra shows, teatros... */,
                            ),
                        ...
                        child: Row(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'CATEGORIATEATRO_Container_m0v6x592_ON_TA');
                                      ...
                                      if (FFAppState().SelectedFilterDate !=
                                        ...
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'CATEGORIATEATRO_Icon_6pka2wqo_ON_TAP');
                                              logFirebaseEvent(
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'CATEGORIATEATRO_Container_fduaxlog_ON_TA');
                                logFirebaseEvent('Container_bottom_sheet');
                                await showModalBottomSheet(
                                  isScrollControlled: true,
                                  backgroundColor: Colors.transparent,
                                      ...
                                      if (FFAppState().SelectedCategory != '')
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'CATEGORIATEATRO_Icon_wapyjm17_ON_TAP');
                                              logFirebaseEvent(
                                                  'Icon_update_app_state');
                                              FFAppState().SelectedCategory =
                                                  '';
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'CATEGORIATEATRO_Container_kqqrbtyw_ON_TA');
                                logFirebaseEvent('Container_bottom_sheet');
                                await showModalBottomSheet(
                                  isScrollControlled: true,
                                  backgroundColor: Colors.transparent,
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'fkq8h1lc' /* Melhores Ofertas em Teatros */,
                        ),
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'dxkrk2lw' /* Todos os Ingressos de Teatros */,
                        ),
                        style: FlutterFlowTheme.of(context).titleLarge.override(
                              font: GoogleFonts.rubik(
                                fontWeight: FlutterFlowTheme.of(context)
                            ...
                            itemBuilder: (context, listViewIndex) {
                              ...
                              return Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'CATEGORIATEATRO_PAGE_Row_tmi0hh16_ON_TAP');
