...
class _ReportEventWidgetState extends State<ReportEventWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'ReportEvent'});
  }
        ...
        appBar: AppBar(
          ...
          leading: Padding(
            ...
            child: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('REPORT_EVENT_PAGE_arrowLeft_ICN_ON_TAP');
          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'i1izb5b7' /* Let us know what's wrong */,
                      ),
                            ...
                            return ListView.separated(
                              ...
                              itemBuilder: (context, reportIndex) {
                                ...
                                return InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'REPORT_EVENT_PAGE_Row_yyj8pght_ON_TAP');
            ...
            Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('REPORT_EVENT_PAGE_SEND_BTN_ON_TAP');
