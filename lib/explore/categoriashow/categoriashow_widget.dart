...
import 'categoriashow_model.dart';
export 'categoriashow_model.dart';
...
class CategoriashowWidget extends StatefulWidget {
  const CategoriashowWidget({super.key});

  static String routeName = 'categoriashow';
  static String routePath = '/categoriashow';

  @override
  State<CategoriashowWidget> createState() => _CategoriashowWidgetState();
}

class _CategoriashowWidgetState extends State<CategoriashowWidget> {
  late CategoriashowModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CategoriashowModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'categoriashow'});
        ...
        appBar: AppBar(
          ...
          leading: Padding(
            ...
            child: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('CATEGORIASHOW_PAGE_arrowLeft_ICN_ON_TAP');
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            children: [
                              Expanded(
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'CATEGORIASHOW_PAGE_Image_9nmr93dy_ON_TAP');
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'gs6adu3d' /* Encontre os melhores eventos m... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              'zneycs5v' /* Descubra shows, teatros... */,
                            ),
                        ...
                        child: Row(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'CATEGORIASHOW_Container_o9ybflsu_ON_TAP');
                                      ...
                                      if (FFAppState().SelectedFilterDate !=
                                        ...
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'CATEGORIASHOW_PAGE_Icon_k9lltl4l_ON_TAP');
                                              logFirebaseEvent(
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'CATEGORIASHOW_Container_j7wr1awb_ON_TAP');
                                logFirebaseEvent('Container_bottom_sheet');
                                await showModalBottomSheet(
                                  isScrollControlled: true,
                                  backgroundColor: Colors.transparent,
                                      ...
                                      if (FFAppState().SelectedCategory != '')
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'CATEGORIASHOW_PAGE_Icon_e0csipwc_ON_TAP');
                                              logFirebaseEvent(
                                                  'Icon_update_app_state');
                                              FFAppState().SelectedCategory =
                                                  '';
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'CATEGORIASHOW_Container_3jvrgmoz_ON_TAP');
                                logFirebaseEvent('Container_bottom_sheet');
                                await showModalBottomSheet(
                                  isScrollControlled: true,
                                  backgroundColor: Colors.transparent,
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'fgqpiuf4' /* Melhores Ofertas em Shows */,
                        ),
                                  ...
                                  child: CarouselSlider.builder(
                                    ...
                                    itemBuilder: (context, carouselIndex, _) {
                                      ...
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'CATEGORIASHOW_Container_trioqoy1_ON_TAP');
                                          logFirebaseEvent(
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'xr3yuuq3' /* Todos os Ingressos de Shows */,
                        ),
                        style: FlutterFlowTheme.of(context).titleLarge.override(
                              font: GoogleFonts.rubik(
                                fontWeight: FlutterFlowTheme.of(context)
                            ...
                            itemBuilder: (context, listViewIndex) {
                              ...
                              return Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'CATEGORIASHOW_PAGE_Row_3arrd9mc_ON_TAP');
