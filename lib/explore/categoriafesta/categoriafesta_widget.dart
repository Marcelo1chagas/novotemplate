...
import 'categoriafesta_model.dart';
export 'categoriafesta_model.dart';
...
class CategoriafestaWidget extends StatefulWidget {
  const CategoriafestaWidget({super.key});

  static String routeName = 'categoriafesta';
  static String routePath = '/categoriafesta';

  @override
  State<CategoriafestaWidget> createState() => _CategoriafestaWidgetState();
}

class _CategoriafestaWidgetState extends State<CategoriafestaWidget> {
  late CategoriafestaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CategoriafestaModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'categoriafesta'});
        ...
        appBar: AppBar(
          ...
          leading: Padding(
            ...
            child: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('CATEGORIAFESTA_PAGE_arrowLeft_ICN_ON_TAP');
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            children: [
                              Expanded(
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'CATEGORIAFESTA_Image_mv80g9ma_ON_TAP');
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  FFLocalizations.of(context).getText(
                                    '5w5nd1k5' /* Encontre os melhores eventos m... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              'ze021lpi' /* Descubra shows, teatros... */,
                            ),
                        ...
                        child: Row(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'CATEGORIAFESTA_Container_6yuk73eb_ON_TAP');
                                      ...
                                      if (FFAppState().SelectedFilterDate !=
                                        ...
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'CATEGORIAFESTA_PAGE_Icon_r8thwtn2_ON_TAP');
                                              logFirebaseEvent(
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'CATEGORIAFESTA_Container_oy03pat1_ON_TAP');
                                logFirebaseEvent('Container_bottom_sheet');
                                await showModalBottomSheet(
                                  isScrollControlled: true,
                                  backgroundColor: Colors.transparent,
                                      ...
                                      if (FFAppState().SelectedCategory != '')
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'CATEGORIAFESTA_PAGE_Icon_04dvgwx4_ON_TAP');
                                              logFirebaseEvent(
                                                  'Icon_update_app_state');
                                              FFAppState().SelectedCategory =
                                                  '';
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'CATEGORIAFESTA_Container_mkyo4bdx_ON_TAP');
                                logFirebaseEvent('Container_bottom_sheet');
                                await showModalBottomSheet(
                                  isScrollControlled: true,
                                  backgroundColor: Colors.transparent,
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'x1k1qon9' /* Melhores Ofertas em Festas */,
                        ),
                                  ...
                                  child: CarouselSlider.builder(
                                    ...
                                    itemBuilder: (context, carouselIndex, _) {
                                      ...
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'CATEGORIAFESTA_Container_ap5lcfmt_ON_TAP');
                                          logFirebaseEvent(
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'jlzyx75k' /* Todos os Ingressos de Festas */,
                        ),
                        style: FlutterFlowTheme.of(context).titleLarge.override(
                              font: GoogleFonts.rubik(
                                fontWeight: FlutterFlowTheme.of(context)
                      ...
                      child: StreamBuilder<List<IngressosRecord>>(
                        stream: queryIngressosRecord(
                          queryBuilder: (ingressosRecord) => ingressosRecord
                              ...
                              .orderBy('data_adicaonoapp', descending: true),
                        ),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                            ...
                            itemBuilder: (context, listViewIndex) {
                              ...
                              return Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'CATEGORIAFESTA_PAGE_Row_um9859ex_ON_TAP');
