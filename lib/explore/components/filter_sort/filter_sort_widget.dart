...
import 'filter_sort_model.dart';
export 'filter_sort_model.dart';
...
class _FilterSortWidgetState extends State<FilterSortWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FilterSortModel());
  }
          ...
          children: [
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, listSortIndex) {
                      ...
                      return InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'FILTER_SORT_COMP_Row_7hwyav7u_ON_TAP');
            ...
            Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('FILTER_SORT_COMP_APLICAR_BTN_ON_TAP');
